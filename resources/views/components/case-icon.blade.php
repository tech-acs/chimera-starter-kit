@if($type === 'total')
    <div {{ $attributes->merge(['class' => 'bg-green-500 rounded-md shadow-md p-3 ml-4 -mt-4 absolute']) }}>
...
@elseif($type === 'complete')
    <div {{ $attributes->merge(['class' => 'bg-blue-500 rounded-md shadow-md p-3 ml-4 -mt-4 absolute']) }}>
...
@elseif($type === 'partial')
    <div {{ $attributes->merge(['class' => 'bg-yellow-500 rounded-md shadow-md p-3 ml-4 -mt-4 absolute']) }}>
...
@elseif($type === 'duplicate')
    <div {{ $attributes->merge(['class' => 'bg-red-500 rounded-md shadow-md p-3 ml-4 -mt-4 absolute']) }}>
...
@else
    <div {{ $attributes->merge(['class' => 'bg-gray-500 rounded-md shadow-md p-3 ml-4 -mt-4 absolute']) }}>
