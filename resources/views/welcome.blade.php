            ...
            <div class="px-4 lg:w-1/2 sm:px-8 xl:pr-16">
                ...
                <div class="mt-10 sm:flex sm:justify-center lg:justify-start">
                    ...
                    <div class="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
                        <a href="https://www.uneca.org/about/contacts" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-indigo-600 bg-white hover:bg-gray-50 md:py-4 md:text-lg md:px-10">
