    ...
    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
        <div class="grid grid-cols-1 gap-6">
            <div>
                ...
                <x-input id="name" disabled name="name" type="text" class="mt-1 block w-full bg-gray-100" value="{{ $report->name }}" />
            ...
            <div>
                <div class="flex justify-between">
                    <x-label for="run_at" value="{{ __('Run at') }}" />
                ...
                <x-input-error for="run_at" class="mt-2" />
            </div>
            <div>
                <div class="flex justify-between">
                    <x-label for="run_every" value="{{ __('Run every') }}" />
                </div>
                ...
                <x-input-error for="run_every" class="mt-2" />
            </div>
        </div>
    </div>
    <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
        <x-secondary-button class="mr-2"><a href="{{ route('manage.report.index') }}">{{ __('Cancel') }}</a></x-secondary-button>
        <x-button>
            {{ __('Submit') }}
        </x-button>
    </div>
