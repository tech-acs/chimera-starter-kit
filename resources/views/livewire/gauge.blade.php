...
>
    <div x-show="dataStatus == 'pending'" x-cloak class="col-start-1 row-start-1">
    ...
    <div
        ...
        class="col-start-1 row-start-1 flex border max-w-64 overflow-hidden p-2 py-1 rounded-lg bg-gray-50/30"
    >
        ...
        <div class="flex flex-col justify-center px-3 max-h-24">
            <div class="text-xl font-semibold text-gray-600 overflow-hidden">{{ $title }}</div>
            <div class="text-sm text-gray-500 overflow-hidden">{{ $subtitle }}</div>
        </div>
    </div>

    <div
        x-show="dataStatus == 'empty'" x-cloak x-transition.duration.500ms
        class="col-start-1 row-start-1 flex border max-w-64 min-h-24 py-4 px-10 items-center text-gray-500 text-wrap rounded-lg bg-gray-50/30"
    >
