                        ...
                        <x-jet-dropdown align="right" width="60">
                            ...
                            <x-slot name="content">
                                <div class="w-48">
                                    ...
                                    <x-jet-dropdown-link class="px-6" href="{{route('connection.index')}}">Databases</x-jet-dropdown-link>
                                    <x-jet-dropdown-link class="px-6" href="{{route('setting')}}">Logo Image</x-jet-dropdown-link>
                                    <x-jet-dropdown-link class="px-6" href="{{route('setting')}}">Application Cache</x-jet-dropdown-link>
                                </div>
                            </x-slot>
                        </x-jet-dropdown>
                    </div>
