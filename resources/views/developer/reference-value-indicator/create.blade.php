<x-app-layout>
    ...
    <div class="flex flex-col max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <form action="{{route('developer.reference-value-indicator.store')}}" method="POST">
            @csrf
            ...
            <div class="shadow sm:rounded-md sm:overflow-hidden">
                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                    <div class="w-1/2">
                        ...
                        <x-input name="indicator" class="mt-1 w-full" value="{{ old('indicator') }}" autofocus />
                        <x-input-error for="indicator" class="mt-2" />
                    </div>
                    <div class="w-1/2">
                        <x-label for="description" value="{{ __('Description') }} *" />
                        <x-input name="description" class="mt-1 w-full" value="{{ old('description') }}" />
