<div class="shadow sm:rounded-md sm:overflow-hidden">
    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
            ...
            <div>
                ...
                <x-jet-input name="simplification_tolerance" class="mt-1" type="number" step="0.01" min="0" value="{{ old('simplification_tolerance', $areaHierarchy->simplification_tolerance ?? 0) }}" />
