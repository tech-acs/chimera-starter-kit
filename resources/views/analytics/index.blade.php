        ...
        <div class="py-2 align-middle inline-block min-w-full">
            ...
            <div class="overflow-hidden bg-white shadow sm:rounded-lg px-4 py-5 sm:px-6">
                ...
                <div class="border-b border-gray-200 pb-5 sm:flex sm:items-center sm:justify-between">
                    ...
                    <div class="text-sm text-red-500">The system is currently configured to log queries that take longer than {{ config('chimera.long_query_time') }} seconds to execute</div>
                </div>
