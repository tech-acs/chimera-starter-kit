                ...
                <div class="p-8 pt-2 bg-white">
                    <div class="grid grid-cols-1 space-y-8" x-data>
                        ...
                        <div>
                            ...
                            <x-chimera::input-hint-error for="scorecard_name" class="mt-2">This will serve as the component name and has to be in camel case</x-chimera::input-hint-error>
                        </div>
