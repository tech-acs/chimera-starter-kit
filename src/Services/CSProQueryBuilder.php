...
class CSProQueryBuilder
{
    ...
    public function __construct($connectionName = null, $excludePartials = true, $excludeDeleted = true, $partialCaseIdentifyingCondition = 'cases.partial_save_mode is NULL', $filter = [])
    {
