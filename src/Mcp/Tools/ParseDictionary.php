...
#[Description('Parse a CSPro dictionary (.dcf) file and return its structure: levels, records, items with types, lengths, labels, and value sets. Use this to understand what data fields are available when writing getData(). Accepts both JSON (CSPro 8+) and INI (pre-CSPro 8.0) formats. You can provide the raw content, or pass a data_source name that was registered via chimera:mcp-install.')]
