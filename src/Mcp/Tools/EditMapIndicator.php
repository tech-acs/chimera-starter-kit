...
#[Description('Update a map indicator\'s metadata after creation. Finds the map indicator by name and updates only the provided fields.')]
class EditMapIndicator extends Tool
{
    ...
    {
        return [
            'name' => $schema->string('Name of the map indicator to edit'),
